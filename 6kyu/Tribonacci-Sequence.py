...
# but summing the last 3 (instead of 2) numbers of the sequence to generate t
# he next. And, worse part of it, regrettably I won't get to hear non-native
...
# instead of [1, 1] basically shifts the common Fibonacci sequence
# by once place, you may be tempted to think that we would get
...
# a fibonacci function that given a signature array/list, returns
# the first n elements - signature included of the so seeded sequence.
#
# Signature will always contain 3 numbers; n will always be
# a non-negative number; if n == 0, then return an empty array
