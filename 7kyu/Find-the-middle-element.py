...
# with a triplet, returns the index of the numerical element that lies
...
# gimme([2, 3, 1]) => 0
#
# 2 is the number that fits between 1 and 3 and the index of 2 in
...
def gimme(input_array):
    return sorted(range(len(input_array)), key=lambda i: input_array[i])[1]
