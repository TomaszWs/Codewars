# Classy Extensions
#
# The goal of this kata is to train the basic OOP concepts of inheritance and
# method overriding.
#
# You will be preloaded with the Animal class, so you should only edit the Cat
# class.
# Task
#
