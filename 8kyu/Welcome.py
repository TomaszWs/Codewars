...
#     Write a 'welcome' function that takes a parameter 'language', with a
#     type String, and returns a greeting - if you have it in your database.
...
def greet(language):
    ...
    for l,greeting in data:
        if l == language: return greeting
    return "Welcome"
