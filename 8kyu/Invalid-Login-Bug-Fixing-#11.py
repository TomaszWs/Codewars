...
# Timmy, being the top coder he is, has allowed some bad code through. You must
# help Timmy and filter out any injected code!
# Task
#
# Your task is simple, search the password string for any injected code
# (Injected code is any thing that would be used to exploit flaws in the
# current code, so basically anything that contains || or //) if you find any
# you must return "Wrong username or password!" because no one likes someone
...
# 'Successfully Logged in!' if it passes the test or 'Wrong username or
# password!' if either the password is wrong or username does not exist.
# Usage
#
# database = Database()
