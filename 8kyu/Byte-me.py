...
# makes it an object, as well as all of it's other properites... it would have
# to take up a bit more than 5 bytes, wouldn't it?
#
# This might be useful for sending something over a network, where you need to
# represent the memory size the item takes up.
# Task:
#
# In this kata, you need to return the number of bytes (aka. memory size) a
# given object takes up.
#
# Different variable types will be given, but they will all be valid. Also,
# random generation for strings takes out of Unicode, not the regular
# 255 ascii letters.
#
