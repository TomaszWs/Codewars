...
# JS, to keep the same indentation on Python and to put an end in Ruby where
# it indeed ends.
#
...
# ":" in both Ruby and JS; in Python you put the condition in the middle of
# two alternatives. The two examples above can be simplified with ternary
# operator:
#
# def odd_even(n):
