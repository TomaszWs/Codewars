# Introduction
#
# floats have limited precision and are unable to exactly represent some
# values. Rounding errors accumulate with repeated computation, and numbers
# expected to be equal often differ slightly.
#
...
#     loss of precision; the function should return True if and only if the two
#     values are close to each other, the maximum allowed difference is 0.001
#
...
# tolerance is better. Fixed tolerance is useful for comparisons near zero or
# when the magnitude of the values is known.
