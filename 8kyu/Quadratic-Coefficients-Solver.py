# In this Kata you are expected to find the coefficients of quadratic equation
# of the given two roots (x1 and x2).
#
...
# quadratic(0,1) = (1, -1, 0)
#
# This means (x-0) * (x-1) = 0; when we do the multiplication this becomes
# x^2 - x + 0 = 0
# Notes
#
